...
{#each data.posts as post}
  <div class="post">
    <h5 class="category label primary-label">
      <a href="/blog/1">blog</a> ▸ <a href={`/blog/${post.category_slug}/1`}>{post.category}</a>
    </h5>
...
<Pagination parentPath={`/blog/${data.posts?.[0]?.category_slug}`} currentPage={$page.params.page} pageCount={data.pageCount} />

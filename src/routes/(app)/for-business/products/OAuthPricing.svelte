...
<FlexContainer id="pricing" column align_items="center" bgColor="var(--landing-outer-bg-color)" color="var(--text-color)" padding="4rem max(1rem, 5vw)" gap="3rem">
  <FlexContainer justify_content="center" textCentered>
    <h1 class="no-margin"><small>Flexible and Transparent Pricing.</small></h1>
  </FlexContainer>
  ...
  <GridContainer width="100%" height="auto" align_items="stretch" justify_items="center" template_columns="2fr 2fr 3fr 3fr" mobile_template_columns="1fr 1fr" gap="1rem">
    <FlexContainer column width="100%" align_items="flex-start" template_columns="auto 1fr" bgColor="var(--new-layer-color)" padding="1rem" gap="0.5rem" rounded border overflow>
  ...
  <span class="sm">Pricing also applies to "Subscribe Anonymously".</span>
</FlexContainer>
